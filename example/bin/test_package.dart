...
final List<DartedCommand> commandsTree = [
  DartedCommand(
    ...
    arguments: [
      ...
      DartedArgument(name: 'platforms', description: 'the platforms to allow in creation', abbreviation: 'p', acceptedMultiOptionValues: 'android,ios,web', isMultiOption: true, optionsSeparator: ','),
    ],
    ...
    flags: [
      ...
      DartedFlag(name: 'package', abbreviation: 'pa', description: 'the helper for the flag.', canBeNegated: false, appliedByDefault: true),
    ...
    subCommands: [
      DartedCommand(
          ...
          callback: (arguments, flags) {
            ...
            ConsoleHelper.loadWithTask(task: 'doing something...', process: () async => await Future.delayed(const Duration(seconds: 4)));
