...
class AsciiArtModule {
  /// Convert text to Ascii art with customizable fonts.
  static Future<String> textToAscii(String text, {AsciiFont font = AsciiFont.slant, String beforeEachLine = '', ConsoleColor? color}) async {
    //
