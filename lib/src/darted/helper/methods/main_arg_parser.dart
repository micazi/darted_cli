...
Future<Map<String, (Map<String, dynamic> arguments, Map<String, bool> flags)>>
    parseMainArgImpl({
    ...
    if (commandEntry.arguments != null &&
      ...
      if (mainArgs.length > 1) {
        ...
        commandsWithMainArgs
            .addEntries([MapEntry(commandEntry.name, mainArgs.first.name)]);
      }
    }
  }
    ...
    if (commandsWithMainArgs.containsKey(commandEntry.key)) {
      ...
      if (callStack.entries.length > 1 &&
        ...
        if (commandEntry.value.$2.isNotEmpty &&
          ...
          ConsoleHelper.write(
            customCommandInvalidError?.call(commandEntry.key, null) ??
