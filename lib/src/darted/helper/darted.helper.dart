...
class DartedHelper {
  ...
  static Map<String, dynamic> parseInput(List<String> input) =>
      parseInputImpl(input);

  /// Parse the commands, arguments, and flags into a CallStack.
  static MapEntry<String, (Map<String, dynamic>, Map<String, bool>)>?
      parseCommandToCallStack(
    ...
    List<String> parsedFlags,
          ...
          parseCommandToCallStackImpl(currentCommand, input, parsedCommands,
  ...
  static Future<
      (
        ...
        String? errorCode
          ...
          Map<String, (Map<String, dynamic> arguments, Map<String, bool> flags)>
              callStack,
          {String Function(String command, String?)?
              customCommandInvalidError}) async =>
      parseMainArgImpl(
