...
Future<void> writeStringToFile(String path, String content, {bool rewrite = true}) async {
  File file = File(path);
  await file.writeAsString(content, mode: rewrite ? FileMode.write : FileMode.append);
}
...
Future<void> writeBytesToFile(String path, Uint8List content, {bool rewrite = true}) async {
  File file = File(path);
  await file.writeAsBytes(content, mode: rewrite ? FileMode.write : FileMode.append);
}
