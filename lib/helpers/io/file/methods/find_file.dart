...
Future<List<String>> findFilesByName(String rootPath, String name,
    ...
    await for (final entity in dir.list(recursive: true, followLinks: false)) {
      if (entity is File &&
        ...
        final isMatch = exactMatch
            ? fileName.trim() == name.trim()
            : fileName.trim().contains(name.trim());
        if (isMatch) {
...
Future<List<String>> findFilesByPattern(String rootPath, RegExp pattern,
